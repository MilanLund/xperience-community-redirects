...
- When creating a redirect, you can specify an anchor to be added to the target URL. This anchor will be appended to the target URL when the redirect occurs.
